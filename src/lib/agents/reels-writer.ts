 ...
 *
 * تطبیق با برند: نسخه‌ی اصلی این دستورالعمل لحن محاوره‌ای و خطاب «تو»
 * می‌خواست، ولی برندگاید صریحاً «همیشه با خطاب شما» را الزام می‌کند و خودِ
 * دستورالعمل هم گفته در تناقض، برندگاید اولویت دارد. نتیجه:
...
- خطاب همیشه «شما» است، نه «تو». (برندگاید)
...
۳) دعوت به اقدام: از فهرست پایین **دقیقاً یکی** را انتخاب کن — و اگر آن یکی از نوع «دعوت مستقیم» بود، هیچ دعوت مستقیم دیگری را جای دیگری از اسکریپت یا کپشن تکرار نکن.
