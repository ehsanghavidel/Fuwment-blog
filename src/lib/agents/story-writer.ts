...
- تصویرِ AI فقط برایِ **فریمِ اول** ساخته می‌شود. پس فقط فریمِ اول باید «imageSubject» داشته باشد: یک صحنه‌ی فیزیکیِ قابلِ عکاسی که از دلِ همین بریف بیرون می‌آید (نه یک مفهومِ انتزاعی، نه کلیشه‌ی «لپ‌تاپ روی میز»). یک جمله.
- فریم‌های بعدی «imageSubject» **نباید** داشته باشند — این فیلد را برای آن‌ها اصلاً پر نکن.
