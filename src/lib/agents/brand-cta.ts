 ...
 *
 * مصرف‌کننده‌ها: استراتژیست بلاگ و ارکستریتور بلاگ، کپی‌رایتر ریلز و
 * ارکستریتور ریلز. (این فایل قبلاً reels-cta.ts نام داشت، از زمانی که فقط
 * ریلز CTA فهرست‌شده داشت. اسمش عوض شد چون محتوایش هیچ چیز مخصوص ریلز ندارد.)
 *
...
/**
 * توصیف هر مسیر برای تزریق به پرامپت‌ها.
 *
 * چرا اینجا و نه در استراتژیست: همان استدلال CTA. مسیر یک قاعده‌ی
 * کسب‌وکار است و ایده‌یاب، استراتژیست و برنامه‌ریز اینستاگرام باید از یک
 * منبع بخوانند. دو توصیف موازی یعنی دو تعریف از یک مسیر.
 */
export const ROUTE_BRIEFING: Record<BrandRoute, string> = {
  brand:
