...
- persian: ${input.brief.language === "en"
      ? "انگلیسی طبیعی — جمله‌های کوتاه و مستقیم، بدون بوی ترجمه از فارسی؟ (این محتوا **عمداً** انگلیسی است. انگلیسی‌بودنش ایراد نیست و هرگز نباید در issues بیاید.)"
      : "فارسی طبیعی — بدون ترجمه‌زدگی و جمله‌های ماشینی؟"}
